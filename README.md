...
- Полноценное приложение с постами, комментариями, лайками, подписками
- Авторизация через JWT, управление состоянием через react-query
- Проект занял первое место на защите диплома, получил высокую оценку преподавателей
...
- Моя роль: дизайн макетов, вёрстка, анимации, интеграция с API
...
- **Клиентский веб-сайт** — запись на сервис, каталог услуг, отзывы, личный кабинет.
