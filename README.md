...
### [АвтоТех — сайт СТО с REST API](https://github.com/gaspacho2103/autotechnical)
**PHP + MySQL + REST API**

- Полноценный сайт с админ-панелью, управлением записями, каталогом услуг
- Спроектировал базу данных, реализовал авторизацию и API
...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/MySQL-4479A1?style=for-the-badge&logo=mysql&logoColor=white" title="MySQL" alt="MySQL" height="200" style="margin-top: 0; padding-top:0"/>&nbsp;
  <img src="https://img.shields.io/badge/SQL-025E8C?style=for-the-badge&logo=amazon-dynamodb&logoColor=white" title="SQL" alt="SQL" height="200" style="margin-top: 0; padding-top:0"/>&nbsp;
